  ...
  return (
    <nav className="border-t border-theme-border dark:border-theme-border-dark px-4 flex items-center justify-between sm:px-0">
      <div className="-mt-px w-0 flex-1 flex">
        {hasPrevious && (
          <a
            className="cursor-pointer border-t-2 border-transparent pt-4 pr-1 inline-flex items-center text-sm font-medium text-theme-text dark:text-theme-text-dark hover:opacity-75"
            onClick={onPrevious}
          >
      ...
      <div className="-mt-px w-0 flex-1 flex justify-end">
        {hasNext && (
          <a
            className="cursor-pointer border-t-2 border-transparent pt-4 pl-1 inline-flex items-center text-sm font-medium text-theme-text dark:text-theme-text-dark hover:opacity-75"
            onClick={onNext}
          >
            Next
