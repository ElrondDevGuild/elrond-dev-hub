...
export default function Tabs({ children, onChange }: { onChange?: (tab: string) => void; children: ReactElement[] }) {
  ...
  return (
    <div className="flex flex-col items-center flex-grow">
      ...
      <hr className="w-full h-0.5 bg-theme-border dark:bg-theme-border-dark mt-1 mb-2 border-0" />
