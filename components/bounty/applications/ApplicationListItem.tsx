...
export default function ApplicationListItem({
  ...
  return (
    <li key={application.id}>
      <div className={classNames("flex items-center justify-between py-2", loading ? "animate-pulse" : "")}>
        <div className="flex flex-col md:flex-row items-start md:items-center gap-x-6 gap-y-1  w-1/2 md:w-2/3 lg:w-1/2">
          <p className="truncate text-sm font-medium text-theme-text dark:text-theme-text-dark w-1/2">
